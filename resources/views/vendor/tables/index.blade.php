...
<div
    ...
    @if (!$isLoaded) wire:init="loadTable" @endif>
    <x-tables::container>
        <div
                                ...
                                @if (\Illuminate\Support\Arr::exists($cachedBA, $exportKey))
                                    <div class="shrink-0">
                                        <x-filament::pages.actions
                                            x-show="selectedRecords.length"
                                            :actions="[$this->getCachedTableBulkAction($exportKey)]"
                                        />
                                    </div>
                                @endif
                ...
                @else
                    ...
                    >
                        @foreach ($records as $record)
                            ...
                            <div
                                @if ($hasCollapsibleColumnsLayout) x-data="{ isCollapsed: @js($collapsibleColumnsLayout->isCollapsed()) }"
                                ...
                                >
                                    <div @class([
                                        ...
                                        @if (count($actions))
                                            <x-tables::actions
                                                :actions="$actions"
                                                :alignment="$actionsPosition === ActionsPosition::AfterContent
                                                    ? 'left'
                                                    : 'left md:right'"
                                                :record="$record"
                                                wrap="-md"
